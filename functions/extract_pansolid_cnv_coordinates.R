extract_pansolid_cnv_coordinates <- function(df, cnv_coord_col) {
  ...
  #'
  #' @param df A dataframe containing a column of CNV coordinates to parse. 
  #' This function was designed mainly to be used with the "Positive/Significant
  #'  CNV results" table in the PanSolid Excel output.
  #' @param cnv_coord_col The column in the dataframe containing the CNV 
  #' coordinates separated by two full stops (Example: "15889325..15946102")
  #' 
