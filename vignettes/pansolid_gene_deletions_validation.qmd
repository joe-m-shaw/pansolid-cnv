...
Somatic copy number changes are a common pathogenic mechanism in cancers,
...
(CGH) and SNP-microarrays, before progressing to next generation sequencing
(NGS) of gene-panels, exomes [@zare2017] and genomes [@das2013]. 
...
approach is to combine sequence dosage and allele-frequency analysis, which was 
first introduced by combining array CGH and SNP-arrays [@vanloo2010; 
@gardina2008] and has since been adopted for NGS approaches [@carter2012]. NGS 
...
The Genomics England cancer pipeline predicts somatic CNVs using Manta 
[@chen2016] and estimates tumour content using Ccube [@yuan2018].
