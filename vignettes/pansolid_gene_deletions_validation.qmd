...
### Clinical impact of other genes

The clinical impact of the remaining genes is summarised below:
...
7 **Analysis:** there should be a clear procedure for analysis fo gene deletions by laboratory staff.
...
## Orthogonal testing: droplet digital PCR
...
## Orthogonal testing: whole genome sequencing

The Genomics England cancer pipeline estimates tumour content using the Ccube algorithm [@yuan2018].

## Orthogonal testing: loss of heterozgosity

4 microsatellite repeat markers (22S275, D22S929, NF2CAV and D22S268) on chromosome 22 are used to assess loss of heterozygosity (LOH) for the *NF2* gene with fluorescence-PCR analysed on an ABI-3130 analyser ([LP000069: Neurofibromatosis type 2 (NF2): Standard Operating Procedure]{custom-style="Strong"}). We used these samples as proof-of-concept that the PanSolid pipeline can identify regions of LOH.
