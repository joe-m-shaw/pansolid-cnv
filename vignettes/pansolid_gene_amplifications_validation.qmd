...
results_by_cancer_type <- ggplot(amp_results_with_cancer_types |> 
  ...
  facet_wrap(~cancer_type_new, nrow = 2, axes = "all_x") +
...
all_amp_gene_results_with_ids <- validation_all_amp_gene_results_collated |> 
  left_join(validation_sample_patient_info,
...
WGS did detect copy number losses and regions of loss of heterozygous in some target genes, but these were excluded as the current aim of the PanSolid CLC pipeline is to detect gene amplifications.
...
false_neg_pansolid <- validation_all_amp_gene_results_collated |> 
