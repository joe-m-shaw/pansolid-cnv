...
#| tbl-cap: "SeraCare gene construct overlap regions. Coordinates are shown in genome build GRCh38, converted from GRCh37 using the [Ensembl Assembly Converter tool](http://www.ensembl.org/Homo_sapiens/Tools/AssemblyConverter)."
#| echo: FALSE
#| warning: FALSE
...
seracare_grch38_regions <- read_csv(file = paste0(data_folder, 
  ...
  mutate(gene_length_kb = round(abs(region_end_whole_gene - region_start_whole_gene) / 1000,
                                1),
         overlap_length_kb = round(abs(region_start_construct_2 - region_end_construct_1) / 1000,
         1),
         overlap_percent = round((overlap_length_kb / gene_length_kb ) * 100, 1),
         overlap_string = str_c(chrom, ":", region_end_construct_1, "_", region_start_construct_2),
...
### Comparison to WGS without tetraploid samples 
...
When the tetraploid samples are removed from the analysis, these are the WGS comparison results. 
