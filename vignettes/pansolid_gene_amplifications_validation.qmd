...
wgs_pansolid_summary_table <- pansolid_vs_wgs_amps_selection_cnvs_above_ten |> 
  ...
  pivot_wider(id_cols = c(gene),
            ...
            names_expand = TRUE) |> 
  adorn_totals() |> 
  mutate("Sensitivity (%)" = as.character(round(calc_sensitivity(tp = true_positive,
                                          tn = true_negative,
                                          fn = false_negative,
                                          fp = false_positive), 1)),
         "Specificity (%)" = round(calc_specificity(tp = true_positive,
                                          ...
                                          fn = false_negative,
                                          fp = false_positive), 1),
         "Sample loci" = true_positive + true_negative + false_negative +
                         false_positive) |> 
  rename(`Gene` = gene,
         `True negatives` = true_negative,
         `True positives` = true_positive,
...
wgs_pansolid_summary_table[wgs_pansolid_summary_table == "NaN"] <- "-"
