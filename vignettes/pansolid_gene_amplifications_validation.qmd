...
pansolid_vs_ddpcr <- validation_ddpcr_collated_erbb2_fixed |> 
...
ddpcr_false_neg_table <- pansolid_vs_ddpcr |> 
...
when compared to ddPCR (@sec-results-ddpcr-comparison),and a sensitivity and specificity of 83.3% and 100% when compared to WGS (@sec-results-wgs-comparison).
