...
plot_all_erbb2_amplification_coordinates <- make_cnv_triptych(plot_xmin = erbb2_labno[[1]],
...
egfr_fc_plot <- make_fold_change_plot(ymax = 50)
...
braf_plot <- make_labno_plot(gene = "BRAF", interval = 200000)
