...
knitr::kable(all_samples_summary_table)
...
knitr::kable(patient_summary_type)
...
knitr::kable(normal_summary_type)
...
knitr::kable(patient_summary_extraction)
...
knitr::kable(normal_summary_extraction)
...
knitr::kable(discode_summary_table)
...
ngs_ddpcr_quant_plot <- ddpcr_pansolid |> 
...
knitr::kable(inter_results)

knitr::kable(intra_results)
...
plot_21011525 <- make_erbb2_plot(labno = 21011525, interval = 10000, buffer = 5000, 
                            input_setting = "coarse",
                ymax = 30,
                exon_y = -10,
                exon_y_buffer = 5, 
...
knitr::kable(pansolid_core_confusion)
