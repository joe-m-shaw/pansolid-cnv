...
gene_labels <- read_csv(file = paste0(config::get("data_folderpath"), 
...
write.csv(gene_labels, file = paste0(config::get("data_folderpath"), 
                                     "validation/DOC6283_amplifications/",
...
transcript_files <- list.files(paste0(config::get("data_folderpath"), 
                                      "validation/DOC6283_amplifications/",
...
write.csv(all_transcripts, file = paste0(config::get("data_folderpath"), 
                                         "validation/DOC6283_amplifications/",
                                         "transcripts/processed/",
